...
const index$3 = require('./index-9bfcb6e8.js');
    ...
    componentDidLoad() {
        {
            rIC(async () => {
                ...
                if (ionicGlobal.config.getBoolean('statusTap', isHybrid)) {
                    Promise.resolve().then(function () { return require('./status-tap-7ad5f0fb.js'); }).then((module) => module.startStatusTap());
                }
                ...
                const hardwareBackButtonModule = await Promise.resolve().then(function () { return require('./hardware-back-button-2696acaf.js'); });
